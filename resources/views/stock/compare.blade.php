    ...
    <div class="container">
        <div class="row align-items-center" style="position:relative;z-index:1;padding-bottom:2rem;">
            <div class="col-md-8">
                ...
                <h1 style="font-size:2.4rem;font-weight:800;margin-bottom:0.5rem;color:white;line-height:1.2;">So Sánh Cổ Phiếu</h1>
                <p style="opacity:0.85;font-size:1rem;margin:0;">Tối đa 4 mã · Biểu đồ tăng trưởng % · Dữ liệu lịch sử</p>
            </div>
...
<div class="container" style="padding-top:2rem;padding-bottom:3rem;">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between mb-3" style="gap:0.75rem;">
            <div>
                <h4 style="font-weight:700;color:#1f2937;margin:0;font-size:1.1rem;">
                    ...
                    Thêm mã cổ phiếu để so sánh
                </h4>
                <p style="color:#9ca3af;font-size:0.82rem;margin:4px 0 0;">Tối đa 4 mã · Nhập mã hoặc chọn gợi ý</p>
            </div>
    ...
    <div id="loadingState" class="text-center py-5" style="display:none;">
        ...
        <p style="color:#6b7280;font-weight:500;">Đang tải dữ liệu so sánh...</p>
    </div>
    ...
    <div id="emptyState" class="empty-state" data-aos="fade-up">
        ...
        <h4 style="color:#6b7280;font-weight:700;margin-bottom:0.5rem;">Thêm mã cổ phiếu để bắt đầu</h4>
        <p style="color:#9ca3af;font-size:0.9rem;">Nhập tối đa 4 mã cổ phiếu phía trên để so sánh hiệu suất</p>
    </div>
            ...
            <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:1rem;flex-wrap:wrap;gap:10px;">
                <div>
                    <h4 style="font-weight:700;color:#1f2937;margin:0;font-size:1.1rem;">
                        ...
                        Biểu đồ tăng trưởng so sánh (%)
                    </h4>
                    <p style="color:#9ca3af;font-size:0.78rem;margin:3px 0 0;">Tăng trưởng % so với ngày đầu tiên trong kỳ dữ liệu</p>
                </div>
                <div style="display:flex;gap:6px;" id="periodBtns2">
                    ...
                    <button class="period-btn2" data-months="0">Tất cả</button>
                </div>
            </div>
        ...
        <div class="stats-table" data-aos="fade-up">
            ...
            <div class="table-responsive">
                <table>
                    <thead>
                        <tr>
                            <th style="text-align:left;padding-left:1.5rem;">Mã CP</th>
                            <th>Tên công ty</th>
                            <th>Giá hiện tại</th>
                            <th>Tăng trưởng</th>
                            <th>Cao nhất</th>
