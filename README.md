...
- **Admin Panel** — Manage users, roles & permissions, stocks, news, portfolios, sync status, and an activity timeline.
...
- **Trang quản trị** — Quản lý người dùng, vai trò & quyền hạn, cổ phiếu, tin tức, danh mục, trạng thái đồng bộ và nhật ký hoạt động.
...
| Queue | Redis Queue — 6 worker song song (Docker supervisor) |
